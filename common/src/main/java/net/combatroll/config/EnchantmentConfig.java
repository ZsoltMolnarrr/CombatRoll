...
public class EnchantmentConfig {
    public AmplifierEnchantment.Properties longfooted = new AmplifierEnchantment.Properties(5, 10, 9, 1F);
    ...
    public AmplifierEnchantment.Properties multi_roll = new AmplifierEnchantment.Properties(4, 15, 9, 1F);
}
