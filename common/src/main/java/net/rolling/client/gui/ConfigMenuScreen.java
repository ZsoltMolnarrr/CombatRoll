...
public class ConfigMenuScreen extends Screen {
    ...
    public ConfigMenuScreen(Screen parent) {
        super(Text.translatable("gui.rolling.config_menu"));
    ...
    protected void init() {
        ...
        addDrawableChild(new ButtonWidget(buttonCenterX, buttonCenterY, buttonWidth, buttonHeight, Text.translatable("gui.rolling.settings"), button -> {
            client.setScreen(AutoConfig.getConfigScreen(ClientConfigWrapper.class, this).get());
        }));
        addDrawableChild(new ButtonWidget(buttonCenterX, buttonCenterY + 30, buttonWidth, buttonHeight, Text.translatable("gui.rolling.hud"), button -> {
